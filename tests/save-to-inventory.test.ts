...
test.describe('Performance: save-to-inventory', () => {
  ...
  test('should batch category and item creation', async () => {
    ...
    Object.defineProperty(prismaModule.prisma, 'user', { value: mockPrisma.user, configurable: true });
    Object.defineProperty(prismaModule.prisma, 'dayPlan', { value: mockPrisma.dayPlan, configurable: true });
    Object.defineProperty(prismaModule.prisma, 'inventoryCategory', { value: mockPrisma.inventoryCategory, configurable: true });
    Object.defineProperty(prismaModule.prisma, 'inventoryItem', { value: mockPrisma.inventoryItem, configurable: true });
