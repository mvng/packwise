              ...
              {editingNotes?.id === item.id ? (
                <div className="mt-1 flex items-start gap-1" onClick={e => e.preventDefault()}>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <button onClick={() => setEditingNotes(null)} aria-label="Cancel editing note" className="p-1 bg-gray-100 text-gray-500 rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1"><X className="w-3 h-3" /></button>
                  </div>
                </div>
              ) : item.notes ? (
                <p
        ...
        {!readOnly && (
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100">
            <button
              ...
              className="text-xs p-1 rounded-full border bg-white text-gray-400 border-gray-200 hover:border-blue-300 hover:text-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 flex items-center justify-center focus-visible:opacity-100"
            ...
            <button
              ...
              className={`text-xs p-1 rounded-full border transition-colors focus:outline-none focus:ring-2 focus:ring-amber-400 flex items-center justify-center focus-visible:opacity-100 ${
                item.packLast
            ...
            <button
              ...
              className="text-red-400 hover:text-red-600 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded px-1 focus-visible:opacity-100"
                            ...
                            >
                              ...
                              {!readOnly && (
                                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100">
                                  ...
                                  <button onClick={() => handleDelete(item.id, category.id, list.id)} aria-label={`Remove ${item.name} from packing list`} className="text-red-400 hover:text-red-600 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded px-1 flex items-center focus-visible:opacity-100"><X className="w-4 h-4" /></button>
                                </div>
                              )}
                            </li>
                          )
