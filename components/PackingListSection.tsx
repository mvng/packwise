              ...
              {editingNotes?.id === item.id ? (
                <div className="mt-1 flex items-start gap-1" onClick={e => e.preventDefault()}>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <button onClick={() => setEditingNotes(null)} aria-label="Cancel editing notes" className="p-1 bg-gray-100 text-gray-500 rounded hover:bg-gray-200"><X className="w-3 h-3" /></button>
                  </div>
                </div>
              ) : item.notes ? (
                <p
        ...
        {!readOnly && (
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100">
            <button
              ...
              title="Add/Edit Note" aria-label="Add/Edit Note"
                              ...
                              {!readOnly && (
                                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100">
                                  ...
                                  <button
                                    ...
                                    title="Add to departure checklist" aria-label="Add to departure checklist"
