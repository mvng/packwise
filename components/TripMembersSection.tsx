      ...
      <div className="flex items-center flex-wrap gap-1.5">
        ...
        {isOwner && !isAdding && (
          <button
            ...
            className="w-7 h-7 rounded-full border border-dashed border-gray-300 text-gray-400 hover:border-blue-400 hover:text-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 flex items-center justify-center transition-colors"
            title="Add member"
      ...
      {isAdding && (
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 disabled:opacity-50 transition-colors"
            title="Confirm"
