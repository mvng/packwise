        ...
        {members.map(member => (
          <div key={member.id} className="group relative">
            <button
              ...
              title={member.name}
              aria-label={`${member.name}${isOwner ? ' (Click to remove)' : ''}`}
            >
      ...
      {isAdding && (
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors"
            title="Cancel"
