      ...
      <div className="flex items-center flex-wrap gap-1.5">
        ...
        {members.map(member => (
          <div key={member.id} className="group relative">
            <button
              ...
              className={`w-7 h-7 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-[10px] font-bold ring-2 ring-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 ${
        ...
        {isOwner && !isAdding && (
          <button
            ...
            className="w-7 h-7 rounded-full border border-dashed border-gray-300 text-gray-400 hover:border-blue-400 hover:text-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 flex items-center justify-center transition-colors"
            title="Add member"
