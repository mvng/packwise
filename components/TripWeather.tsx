...
export default function TripWeather({ destination, startDate, endDate, variant = 'card' }: TripWeatherProps) {
  ...
  return (
    <div 
      className={`${isCard ? 'mt-3 pt-3 border-t border-gray-100' : 'bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl border border-blue-100 p-4'} relative cursor-help`}
    ...
    >
      ...
      {/* Disclaimer tooltip - appears on hover over entire weather section */}
      {showTooltip && (
