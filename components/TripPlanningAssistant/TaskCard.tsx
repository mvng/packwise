    ...
    >
      <div className="flex items-start gap-3">
        <button
          ...
          className={`mt-1 flex-shrink-0 text-gray-400 hover:text-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-colors ${
        ...
        <div className={`flex items-center gap-1 transition-opacity opacity-0 group-hover:opacity-100 focus-within:opacity-100`}>
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-blue-600 rounded-md hover:bg-blue-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:opacity-100 transition-colors"
            title="Edit task"
          >
          ...
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-red-600 rounded-md hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:opacity-100 transition-colors"
            title="Delete task"
          >
