    ...
    >
      <div className="flex items-start gap-3">
        <button
          ...
          className={`mt-1 flex-shrink-0 text-gray-400 hover:text-blue-600 transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none rounded-full ${
        ...
        <div className={`flex items-center gap-1 transition-opacity focus-within:opacity-100 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
          <button
            onClick={() => onEdit(task)}
            className="p-1.5 text-gray-400 hover:text-blue-600 rounded-md hover:bg-blue-50 transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none"
            title="Edit task"
          ...
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-red-600 rounded-md hover:bg-red-50 transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none"
            title="Delete task"
