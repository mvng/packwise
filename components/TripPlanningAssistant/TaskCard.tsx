    ...
    >
      <div className="flex items-start gap-3">
        <button
          ...
          className={`mt-1 flex-shrink-0 text-gray-400 hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-full transition-colors ${
        ...
        <div className={`flex items-center gap-1 transition-opacity focus-within:opacity-100 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
          <button
            onClick={() => onEdit(task)}
            className="p-1.5 text-gray-400 hover:text-blue-600 focus-visible:text-blue-600 rounded-md hover:bg-blue-50 focus-visible:bg-blue-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors"
            title="Edit task"
          ...
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-red-600 focus-visible:text-red-600 rounded-md hover:bg-red-50 focus-visible:bg-red-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 transition-colors"
            title="Delete task"
