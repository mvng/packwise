    ...
    >
      <div className="flex items-start gap-3">
        <button
          ...
          className={`mt-1 flex-shrink-0 rounded-full text-gray-400 hover:text-blue-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
