        ...
        >
          ...
          {allDayTag ? (
            <div className="flex items-center gap-1.5 mt-1">
              ...
              <button onClick={() => saveLabel('')} aria-label="Clear label" className={`ml-auto text-[11px] opacity-60 hover:opacity-100 ${headerText} focus:outline-none leading-none`}>✕</button>
            </div>
          ) : editingLabel ? (
