          ...
          {allDayTag ? (
            <div className="flex items-center gap-1.5 mt-1">
              ...
              <button
                ...
                className={`ml-auto text-[11px] opacity-60 hover:opacity-100 ${headerText} focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 rounded-sm leading-none`}
              >
                ✕
              </button>
            </div>
