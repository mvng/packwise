...
export default function NewTripPage() {
  ...
  // Why: generatePackingList and array reduction are computationally expensive.
  // We don't want to re-run them on every keystroke when typing in the text inputs (name, destination).
  // Impact: Prevents UI lag and unnecessary re-renders when filling out the form.
