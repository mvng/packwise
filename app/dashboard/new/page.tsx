...
export default function NewTripPage() {
  ...
  // Why: Prevents expensive generatePackingList and array reduce operations from running on every keystroke when user types in the controlled form inputs (like destination).
  // Impact: Eliminates UI lag during text input and form interaction.
  ...
  }, [formData.startDate, formData.endDate, formData.generateSuggestions, formData.tripType, formData.transportMode])
